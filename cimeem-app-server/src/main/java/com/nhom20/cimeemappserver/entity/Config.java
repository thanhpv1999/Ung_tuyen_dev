...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8085/check";
    public static String vnp_TmnCode = "PIRTCHT4";
    public static String vnp_HashSecret = "CUWTIVZAWTFHOCKHVTBOKEDNLJDGMJKU";

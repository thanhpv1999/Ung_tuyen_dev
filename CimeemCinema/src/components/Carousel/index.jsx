...
import {  qc, filmTomo, chosseFilm, chosseTheatre, chosseTime } from "../../services/services_customer/listFilmService";

export default function Carousel_Home() {
    const [listFilmNow, setListFilmNow] = useState([]);
    const [listfilm, setListFilm] = useState([]);
    const [listfilmTomo, setListFilmTomo] = useState([]);
    const [listQc, setListQc] = useState({});
    const [listCinema, setListCinema] = useState([]);
    const [listTimes, setListTimes] = useState([]);

    useEffect(() => {
        chosseFilm(setListFilm);
        filmTomo(setListFilmTomo);
        // qc(setListQc);
    }, []);
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                      ...
                      <option value={ticket.movieId}>{ticket.title}</option>
                                    ...
                                    <li>
                                        <select onChange={()=>chosseTheatre(listfilm.data[0].movieId, setListCinema)} class="form-select form-select-sm" aria-label=".form-select-sm example">
                                    ...
                                    <li>
                                        <select onChange={()=>chosseTime(listfilm.data[0].movieId, listCinema.data[0][0], setListTimes)} class="form-select form-select-sm" aria-label=".form-select-sm example">

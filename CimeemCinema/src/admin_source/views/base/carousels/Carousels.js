...
const Carousels = () => {
  ...
  const columns = [
    ...
    { key: "characterName", label: "Character Name", _props: { scope: "col" } },
    { key: "castOrder", label: "Cast Order", _props: { scope: "col" } },
  ...
  useEffect(() => {
    const fetchApi = async () => {
      ...
      let cloneChat = result.map((i) => {
        ...
        } else if (i.castOrder === null) {
          return {
            ...state,
            ...i,
            castOrder: "null",
          };
        } else if (i.castOrder == null && i.characterName == null) {
          return {
            ...state,
            ...i,
            ...{ characterName: "null" },
